package com.touma.springbootmybatisbase.test;
...
import com.touma.springbootmybatisbase.Application;
...
public class MyTest {
   ...
   * @SpringBootTest是定义springboot类型的测试用例
   * classes是配置要测试的springboot启动类
  ...
  /**
   * TestRestTemplate是依赖注入测试模板类Junit
   */
  @Autowired
